...
ALTER TABLE "user_roles" ADD CONSTRAINT "user_roles_assigned_by_user_roles_user_id_fk" FOREIGN KEY ("assigned_by") REFERENCES "public"."user_roles"("user_id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
